      ...
      return (
        <div className="min-h-screen bg-slate-50 pb-20 pt-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="h-8 w-64 bg-slate-200 rounded-lg animate-pulse mb-8"></div>
  ...
  const StatCard = ({
    ...
    <Card className="flex flex-col justify-between h-full hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-2">
        <div
          className={`w-10 h-10 ${bgClass} rounded-full flex items-center justify-center ${colorClass}`}
        >
      ...
      <div>
        ...
        <div className="flex items-center gap-1.5 mt-2">
          <span
            className={`text-xs font-bold ${trend === "up" ? "text-green-600" : "text-red-500"} flex items-center`}
          >
            {trend === "up" ? "+" : "-"}
            {trendValue}
          </span>
          ...
          <Card className="lg:col-span-2">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                <button className="px-3 py-1 bg-violet-600 text-white text-xs font-bold rounded-lg transition-colors">
                  Daily
                </button>
                <button className="px-3 py-1 bg-slate-50 text-slate-600 text-xs font-medium rounded-lg hover:bg-slate-100 transition-colors">
                  Weekly
                </button>
                <button className="px-3 py-1 bg-slate-50 text-slate-600 text-xs font-medium rounded-lg hover:bg-slate-100 transition-colors">
                  Monthly
                ...
                {events.map((event) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-2 py-1 rounded-md text-[10px] font-bold uppercase ${event.status === "published" ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-600"}`}
                        >
                      ...
                      <td className="px-6 py-4 text-center relative">
                        <div className="flex items-center justify-center gap-2 transition-opacity">
                          <Link
                            ...
                            className="p-1.5 hover:bg-gray-100 rounded text-gray-500 hover:text-violet-600"
                            title="Edit Event"
                          >
