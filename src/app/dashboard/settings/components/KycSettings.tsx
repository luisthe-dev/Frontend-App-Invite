...
export default function KycSettings({ user, onUserUpdate }: KycSettingsProps) {
    ...
    if (user?.kyc_status === 'verified') {
        return (
          <div className="bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-900/20 rounded-xl p-6 flex flex-col items-center text-center">
            ...
            <p className="text-green-700 dark:text-green-400 text-sm">
              Your identity has been successfully verified. You have full access
              to all features.
            </p>
          </div>
        );
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              To ensure the safety of our platform and comply with regulations,
