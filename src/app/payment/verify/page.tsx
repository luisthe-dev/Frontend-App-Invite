      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-[480px] w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
          ...
          <div className="space-y-3 mb-8">
            <Link
              href="/payment"
              className="block w-full py-3 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
            ...
            <Link
              href="/"
              className="block w-full py-3 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
            >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500">
            ...
            <span className="font-medium text-gray-900">{emailSentTo}</span>
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-xs font-medium text-gray-700 mb-2 flex items-center">
                    <Calendar className="w-3 h-3 mr-1.5 text-violet-600" /> Add
                    to your calendar
                  </p>
                  <div className="flex gap-2">
                    <button className="px-2 py-1 bg-gray-50 border border-gray-200 rounded text-[10px] text-gray-600 hover:bg-gray-100">
                      Google
                    </button>
                    <button className="px-2 py-1 bg-gray-50 border border-gray-200 rounded text-[10px] text-gray-600 hover:bg-gray-100">
                      Apple
                ...
                <div>
                  <p className="text-xs font-medium text-gray-700 mb-1 flex items-center">
                    <MapPin className="w-3 h-3 mr-1.5 text-violet-600" /> Get
                  ...
                  <a
                    href="#"
                    className="text-[10px] font-medium text-violet-600 flex items-center gap-1 hover:underline"
                  >
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          <div className="flex w-full max-w-md gap-3">
            <Link
              ...
              className="flex-1 py-3 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-xl transition-all text-center text-sm"
            >
              View My Tickets
            </Link>
            <Link
              href="/"
              className="flex-1 py-3 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-all text-center text-sm"
            >
              Return to Home
            </Link>
          </div>
