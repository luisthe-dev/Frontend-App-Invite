      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div className="bg-white py-10 px-6 shadow-xl sm:rounded-2xl sm:px-12 border border-gray-100">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="agreed" className="font-medium text-gray-600 cursor-pointer select-none">
                  I agree to the <Link href="/terms" className="text-violet-600 hover:text-violet-500">Terms of Service</Link> and <Link href="/privacy" className="text-violet-600 hover:text-violet-500">Privacy Policy</Link>
                </label>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                <button 
                  ...
                  className="flex items-center justify-center px-4 py-2.5 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full inline-flex justify-center py-3 px-4 rounded-xl border border-gray-100 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 shadow-sm transition-all"
                >
                  <span className="sr-only">Sign up with Apple</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.128 22 16.991 22 12c0-5.523-4.477-10-10-10z" fillRule="evenodd" clipRule="evenodd" display="none" />
                     {/* Apple Icon */}
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link href="/signin" className="font-semibold text-violet-600 hover:text-violet-500 transition-colors">
              Log in
            </Link>
          </p>
